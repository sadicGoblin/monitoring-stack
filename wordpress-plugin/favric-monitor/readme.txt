...
Desde 1.1.0: integridad de archivos críticos (.htaccess, index.php,
wp-config.php) — hash SHA-256 contra una línea base guardada, con botón
"Actualizar línea base" en Ajustes → Favric Monitor.
